            ...
            [
                dbc.Row(
                    [
                        ...
                        dbc.Col(
                            [
                            dbc.FormText("Enter Keywords", style = {"font-style": "italic"}),
                            dbc.Input(type="text", id="facdet_filter", placeholder="Search"),
...
def facdetails_load(pathname, search): 
    if pathname == '/faculty_details': 
        ...
        for i in range(len(faculty)):
            if faculty['userID'][i] != int(facdetid):
        ...
        if counted > 0: 
            ...
            mail_h = " %s" % (faculty['Mail'][counted] or " ")
            mail = [
                html.Div([
                    html.Strong("Email: "),
                    html.Span(f"{mail_h}"), 
